  ...
  return (
    <div className="flex h-screen">
      <aside className="hidden md:flex w-48 bg-white border-r border-gray-200 p-4 flex-col justify-between">
        <div>
          ...
          <nav className="space-y-10 text-xl">
            ...
            <Link to="/admin/receta" className="block pl-5 hover:text-[#7A0000] hover:font-bold">Asociar ingredientes</Link>
            <Link to="/admin/post" className="block pl-5 hover:text-[#7A0000] hover:font-bold">Crear Publicación</Link>
      ...
      <div className="flex-1 flex flex-col min-w-0"> 
        <header className="w-full flex justify-between items-center p-4 border-b border-gray-200 bg-white shrink-0"> {/* Added shrink-0 */}
          <button 
        ...
        {menuAbierto && (
          <div className="md:hidden absolute top-16 left-0 right-0 bg-white shadow-lg z-40 border-b border-gray-200">
            <nav className="flex flex-col p-4 space-y-4 max-h-[70vh] overflow-y-auto">
              <Link to="/admin/users" className="block py-2 px-4 hover:text-[#7A0000] hover:font-bold" onClick={cerrarMenu}>Lista usuarios</Link>
              <Link to="/admin/menu-promos" className="block py-2 px-4 hover:text-[#7A0000] hover:font-bold" onClick={cerrarMenu}>Menu y promociones</Link>
              <Link to="/admin/pedidos" className="block py-2 px-4 hover:text-[#7A0000] hover:font-bold" onClick={cerrarMenu}>Pedidos</Link>
              <Link to="/admin/reportes" className="block py-2 px-4 hover:text-[#7A0000] hover:font-bold" onClick={cerrarMenu}>Reportes</Link>
              <Link to="/admin/inventario" className="block py-2 px-4 hover:text-[#7A0000] hover:font-bold" onClick={cerrarMenu}>Inventario</Link>
              <Link to="/admin/receta" className="block py-2 px-4 hover:text-[#7A0000] hover:font-bold" onClick={cerrarMenu}>Asociar ingredientes</Link>
              <Link to="/admin/post" className="block py-2 px-4 hover:text-[#7A0000] hover:font-bold" onClick={cerrarMenu}>Crear publicación</Link>
              <Link to="/admin/reservas" className="block py-2 px-4 hover:text-[#7A0000] hover:font-bold" onClick={cerrarMenu}>Reservas</Link>
