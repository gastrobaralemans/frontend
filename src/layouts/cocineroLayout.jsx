        ...
        {menuAbierto && (
          <div className="md:hidden absolute top-16 left-0 right-0 bg-white shadow-lg z-40 border-b border-gray-200">
            <nav className="flex flex-col p-4 space-y-4 max-h-[70vh] overflow-y-auto">
              <Link to="/cocinero/pedidos-cocinero" className="block py-2 px-4 hover:text-[#7A0000] hover:font-bold" onClick={cerrarMenu}>Pedidos</Link>
              <Link to="/cocinero/inventario-cocinero" className="block py-2 px-4 hover:text-[#7A0000] hover:font-bold" onClick={cerrarMenu}>Inventario de ingredientes</Link>
